...
public class GameMapGenerator {
    ...
    public GameMap generate(List<GameCharacter> characters){
        ...
        Door door1 = new Door("floor_ladder.png", new Coordinate(5, 4), CardinalDirection.NORTH);
        Door door2 = new Door("floor_ladder.png", new Coordinate(1, 1), CardinalDirection.EAST);
        Door door3 = new Door("floor_ladder.png", new Coordinate(5, 10), CardinalDirection.EAST);
